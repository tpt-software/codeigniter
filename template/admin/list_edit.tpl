...
<html>
	<head>
		...
		<title>Classification modification</title>
	...
	<form class="layui-form" action="<?=site_url('lists/save/'.$op.'/'.$id)?>" method="post">
        <table class="layui-table">
            ...
            <tbody>
                <tr><td align="center">Category Name</td><td><input type="text" name="name" placeholder="Please enter a category name" value="<?=$name?>" class="layui-input"></td></tr>
                <tr><td align="center">Sort ID</td><td><input type="text" name="xid" placeholder="Please enter the classification sort ID" value="<?=$xid?>" class="layui-input"></td></tr>
