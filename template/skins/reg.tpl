...
<html xmlns="https://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Sign Up - <?=Web_Name?> - Free multimedia cloud disk system - WWW.14412882.com</title>
...
<style>.copyright-reg{position:fixed;bottom:0;left:50%;transform:translateX(-50%);padding:10px;width:100%;text-align:center}.confirm-password-container{display:flex;align-items:center;width:310px}.confirm-password{flex:1;margin-right:5px}.password-toggle{cursor:pointer}.password-toggle img{vertical-align:middle;margin-top:25px}.password-container{display:flex;align-items:center;width:310px}.password{flex:1;margin-right:5px}.password-toggle{cursor:pointer}.password-toggle img{vertical-align:middle;margin-top:25px}.form-container{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background-color:rgb(248 248 248 / .15);border:2px solid #ccc;padding:20px;border-radius:10px;width:500px;height:600px}.username-container{position:relative}.username-container input.username{padding-right:30px}.username-container i{position:absolute;top:70%;right:5px;transform:translateY(-50%);font-size:20px;color:#fff}</style>
    <body>
		...
		<div class="form-container">
            ...
            <form action="<?=links('reg','save')?>" method="post" id="registerForm">
                ...
                <div class="password-container">
                    <input type="password" name="pass" class="password" id="passwordField" placeholder="Password" oncontextmenu="return false" onpaste="return false" />
				...
				<br>
				<p id="capsLockWarning" style="display: none;"><i class="fa fa-exclamation-triangle" style="color: yellow" aria-hidden="true"></i> Caps Lock is on!</p>
                <div>
                    <input type="password" name="repass" class="confirm_password" id="confirmPasswordField" placeholder="Confirm Password" oncontextmenu="return false" onpaste="return false" />
                </div>
				<br>
				<p id="confirmCapsLockWarning" style="display: none;"><i class="fa fa-exclamation-triangle" style="color: yellow" aria-hidden="true"></i> Caps Lock is on!</p>
                <div>
