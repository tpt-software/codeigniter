...
<title>14412882 Friendly Tips</title>
<style type="text/css">
    ...
    <div class="error-page-container">
        <div class="error-page-main">
            ...
            <div class="error-page-actions">
                ...
                <div>
                    <ul>
					    <li id="div_time">Please wait, the page will be at <span id="time" style="font-weight:bold;color:red;">{time}</span> Jump in seconds...</li>
                        <li><a href="{url}">Go to now</a><a style="margin-left:60px;" href="{path}">return home</a></li>
                    </ul>
                </div>
            </div>
        </div>
