                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                        <div class="caption" style="width: 75%;height: 33px;overflow: hidden;">
                                            ...
                                            <span class="caption-subject font-red sbold uppercase">My video &nbsp;</span>
                                              ...
                                              <span class="caption-helper"> （You have uploaded a total of <?=$this->csdb->get_nums('vod',array('uid'=>$user->id))?> videos） </span>
                               ...
                               <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                  <a href="<?=links('vod','index','txt',$cid)?>">Detail mode</a>
                                                </li>
                                                <li class="divider"> </li>
                                                <li>
                                                    <a href="javascript:;"><i class="fa fa-check"></i>Image mode</a>
                                                </li>
                                        ...
                                        <div class="portlet-body dataTables_wrapper">
                                            ...
                                            foreach($vod as $k=>$row){
                                               ...
                                               if ($row->is_remote_m3u8) {
                                                    ...
                                                    $thumbImg = '<img class="lazy" src="'.$row->thumnail_url.'"  style="height: 206px;width: 360px;">';
                                                } else {
                                                    $pic = $pic2 = '';
                                                    for($i = 1;$i<=Jpg_Num;$i++){
                                                    ...
                                                    $thumbImg = '<img class="lazy" src="'.m3u8_link($row->vid,$row->addtime,'pic',1,$server).'"  style="height: 206px;width: 360px;">';
                                                }
                                                echo '
                                                    ...
                                                    <div class="mt-card-item">
                                                        <div class="mt-card-avatar mt-overlay-1">
                                                            <div class="video-time">
                                                              ...
                                                              <span style="float:right;" id="time">'.formattime((int)$row->duration,1).'</span>
                                                            </div>
                                                            '.$thumbImg.'
                                                        ...
                                                        <div class="mt-card-content">
                                                            ...
                                                            <div class="mt-card-social">
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <a href="#long'.$row->id.'" data-toggle="modal" ><i class="fa fa-picture-o"></i> Video screenshot</a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:;">
