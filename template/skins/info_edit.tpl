...
<div class="form-group">
    ...
    <div class="col-md-6">
        <input class="form-control vip-status <?=$vips == 'VIP member' ? 'vip' : 'normal' ?>" type="text" value="<?=$vips?>" disabled>
    </div>
</div>
<div class="form-group">
...
<div class="col-md-6">
<input type="text" name="email" required lay-verify="email" placeholder="Please enter your email" autocomplete="off"  class="form-control"  value="<?=$user->email?>" disabled>
</div>
</div>
<div class="form-group">
    <label class="control-label col-md-3">Join Date</label>
    <div class="col-md-6">
        <input class="form-control" type="text" value="<?= date("d-m-Y", $user->addtime) ?>" disabled>
    </div>
</div>
    <div class="form-group">
...
<div class="col-md-6">
<input type="text" name="url" required lay-required="" placeholder="Please enter your domain name" value="<?=$user->url?>"  class="form-control">
</div>
</div>
<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="telegram" placeholder="Please enter your Telegram" value="<?=$user->telegram?>">
							</div>
							</div>
...
<span style="color: #357ebd;"><i class="fa fa-telegram"></i> Telegram Support Group</span>
</a>
</span>
</label>
<div class="col-md-6">
