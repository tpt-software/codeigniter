/*
	Software name: ckplayer
	Software version: X
	Software author: https://www.ckplayer.com
	---------------------------------------------------------------------------------------------
	Development notes:
	The main programming language used: javascript (js) and actionscript3.0 (as3.0) (as3.0 is mainly used for the development of the flashplayer part and is not presented on this page)
	Function: play video
	Features: Compatible with HTML5-VIDEO (priority) and FlashPlayer
	=====================================================================================================================
*/
...
!(function() {
	...
	var ckplayer = function(obj) {
		...
		*/
		...
		///
		this.contextMenu = [
			['ckplayer', 'link', 'https://321watch.com'],
	...
	ckplayer.prototype = {
		...
		*/
		embedSWF: function() {
			...
			var flashplayerUrl = 'https://www.macromedia.com/go/getflashplayer';
			var html = '',
				src = javascriptPath + 'ckplayer.swf';
			id = 'id="' + vid + '" name="' + vid + '" ';
			html += '<object pluginspage="' + flashplayerUrl + '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"  codebase="https://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=11,3,0,0" width="100%" height="100%" ' + id + ' align="middle">';
			html += param['v'];
